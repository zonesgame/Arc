...
public class Vec2 implements Vector<Vec2>, Position{
    public static final Vec2 X = new Vec2(1, 0), Y = new Vec2(0, 1), ZERO = new Vec2(0, 0), TEMP = new Vec2(0, 0),
    /** zones add*/TEMP2 = new Vec2(0, 0), /** zones add*/ TILE_ISO = new Vec2();
    ...
    public Vec2 clamp(float minx, float maxx, float miny, float maxy){
