...
// * @author Nathan Sweet
// */
//public class ZScrollPane extends WidgetGroup{
...
//    private ZScrollPaneStyle style;
...
//    public ZScrollPane(Element widget){
//        this(widget, scene.getStyle(ZScrollPaneStyle.class));
//    }
//
//    /** @param widget May be null. */
//    public ZScrollPane(Element widget, ZScrollPaneStyle style){
...
//            @Override
//            public boolean touchDown(InputEvent event, float x, float y, int pointer, KeyCode button){
//                Element actor = ZScrollPane.this.hit(x, y, true);
//                on = flickScroll;
//                if(actor instanceof Slider && on){
//                    ZScrollPane.this.setFlickScroll(false);
//                    return true;
//                }
//
...
//            public void touchUp(InputEvent event, float x, float y, int pointer, KeyCode button){
//                if(on){
//                    ZScrollPane.this.setFlickScroll(true);
//                }
...
//     * {@link #setStyle(ZScrollPaneStyle)} is called.
//     */
//    public ZScrollPaneStyle getStyle(){
//        return style;
//    }
//
//    public void setStyle(ZScrollPaneStyle style){
//        if(style == null) throw new IllegalArgumentException("style cannot be null.");
//        this.style = style;
//        invalidateHierarchy();
//    }
...
//
//    /**
//     * The style for a scroll pane, see {@link ZScrollPane}.
//     * @author mzechner
//     * @author Nathan Sweet
//     */
//    public static class ZScrollPaneStyle extends Style{
//        /** Optional. */
...
//
//        public ZScrollPaneStyle(){
//        }
//
//        public ZScrollPaneStyle(ZScrollPaneStyle style){
